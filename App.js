...
class App extends React.Component {
    ...
    renderSelectPhotoControl = localPhotos => {
        return ( <
            ...
            horizontal = { true } > { this.renderListPhotos(localPhotos) } <
            TouchableOpacity onPress = { this.onPressAddPhotoBtn.bind(this) } >
            <
            View style = {
                [styles.addButton, styles.photo] } >
            <
    ...
    render() {
        return ( <
            ...
            /> <
            View style = { styles.body } > { this.renderSelectPhotoControl(this.state.localPhotos) } <
            View style = { styles.sectionContainer } >
            <
            ...
            style = {
                { height: 250, borderColor: 'gray', borderWidth: 1 } }
